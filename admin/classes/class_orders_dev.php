 ...
 class Orders extends Functions{
	...
	function __construct() {
				...
				public function get_id() { return $this->id;}
		 		...
		 		public function get_conservation() { return $this->conservation;}
		 		public function set_conservation($value) {$this->conservation=$value;}
...
public function save() {
	try{
        ...
        VALUES (
								...
								'".mysqli_real_escape_string($dm->connection, $this->get_mount_material())."',
								'".mysqli_real_escape_string($dm->connection, $this->get_conservation())."',
				...
				$strSQL = "UPDATE orders SET 
								orders_customer_id='".mysqli_real_escape_string($dm->connection, $this->get_customer_id())."',						 
						 		...
						 		orders_mount_material='".mysqli_real_escape_string($dm->connection, $this->get_mount_material())."',						 
						 		orders_conservation='".mysqli_real_escape_string($dm->connection, $this->get_conservation())."',						 
						 		...
						 		orders_frame_w='".mysqli_real_escape_string($dm->connection, $this->get_frame_w())."',						 
						 		orders_frame_h='".mysqli_real_escape_string($dm->connection, $this->get_frame_h())."',						 
						 		orders_outer_mat_t='".mysqli_real_escape_string($dm->connection, $this->get_outer_mat_t())."',						 
						 		orders_outer_mat_b='".mysqli_real_escape_string($dm->connection, $this->get_outer_mat_b())."',						 
						 		orders_outer_mat_l='".mysqli_real_escape_string($dm->connection, $this->get_outer_mat_l())."',						 
						 		orders_outer_mat_r='".mysqli_real_escape_string($dm->connection, $this->get_outer_mat_r())."',						 
						 		orders_inner_mat_w='".mysqli_real_escape_string($dm->connection, $this->get_inner_mat_w())."',						 
						 		orders_fillet_w='".mysqli_real_escape_string($dm->connection, $this->get_fillet_w())."',						 
						 		orders_fillet_h='".mysqli_real_escape_string($dm->connection, $this->get_fillet_h())."',						 
						 		orders_rabbet_size='".mysqli_real_escape_string($dm->connection, $this->get_rabbet_size())."',						 
						 		orders_frame_done='".mysqli_real_escape_string($dm->connection, $this->get_frame_done())."',						 
						 		orders_outer_mat_done='".mysqli_real_escape_string($dm->connection, $this->get_outer_mat_done())."',						 
						 		orders_inner_mat_done='".mysqli_real_escape_string($dm->connection, $this->get_inner_mat_done())."',						 
						 		orders_fillet_done='".mysqli_real_escape_string($dm->connection, $this->get_fillet_done())."',						 
						 		orders_glass_done='".mysqli_real_escape_string($dm->connection, $this->get_glass_done())."',						 
						 		orders_mount_done='".mysqli_real_escape_string($dm->connection, $this->get_mount_done())."',						 
...
private function load($row){
	...
	$this->set_conservation($row["orders_conservation"]);
